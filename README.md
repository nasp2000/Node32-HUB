...
The **source code** of this project is **proprietary and closed** — you may view and use it for reference, but you may **not** copy, modify, redistribute, or incorporate it into your own projects without prior written permission.

**Pre-compiled binaries** published in the GitHub Releases of this and the related pack repositories (the dedicated per-board firmware repos built on this codebase) may be **downloaded, flashed, and used free of charge** for any purpose, including commercial use.
